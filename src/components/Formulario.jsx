...
const Formulario = ({ pacientes, setPacientes, paciente, setPaciente}) => {
  ...
  return (
    <div className="md:w-1/2 lg:w-2/5 mx-5">
      <h2 className='font-black text-3xl text-center text-black'>Seguimientos Pacientes</h2>

      <p className='text-xl mt-5 text-center mb-10'> Añade Pacientes y {''}
      <span className='text-red-500 font-bold'>Administralos</span>
      </p>
      ...
      >
        ...
        <div className='mb-5'>
          ...
          <input 
              ...
              className='border-2 w-full p-2 placeholder-gray-400 rounded-md' 
              type="email" 
              placeholder='Eje: contacto@gmail.com'
              value={email} 
        ...
        <input 
          type="submit" 
          className='bg-red-500 text-white w-full p-4 uppercase font-bold hover:bg-red-600 cursor-pointer transition-colors' 
